      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="flex-shrink-0">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center text-gray-300">
                <MapPinIcon className="h-4 w-4 mr-2 text-primary-400 flex-shrink-0" />
                <span>345 RT 17 STE 22, Upper Saddle River, NJ 07458</span>
              </div>
              <div className="flex items-center text-gray-300">
                <PhoneIcon className="h-4 w-4 mr-2 text-primary-400 flex-shrink-0" />
                <Link href="tel:(201) 812-2184" className="hover:text-white transition-colors">
                  (201) 812-2184
                </Link>
              </div>
              <div className="flex items-center text-gray-300">
                <EnvelopeIcon className="h-4 w-4 mr-2 text-primary-400 flex-shrink-0" />
                <Link href="mailto:Service@midlandinsurance.biz" className="hover:text-white transition-colors text-sm">
                  Service@midlandinsurance.biz
                </Link>
              </div>
              <div className="flex items-center text-gray-300">
                <ClockIcon className="h-4 w-4 mr-2 text-primary-400 flex-shrink-0" />
          ...
          <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
            {/* Personal Services */}
            <div>
              <h3 className="text-white text-base font-semibold mb-3">Personal Insurance</h3>
            ...
            {/* Business Services */}
            <div>
              <h3 className="text-white text-base font-semibold mb-3">Business Insurance</h3>
              <ul className="space-y-2">
            ...
            {/* Social & Review */}
            <div>
              <h3 className="text-white text-base font-semibold mb-3">Connect With Us</h3>
